            ...
            <div className="flex items-center gap-3 mt-5 justify-center md:justify-start">
              {socials.map((s) => (
                <a
                  ...
                  aria-label={s.label}
                  className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-[#0A66C2] text-[#0A66C2] text-sm font-medium hover:bg-[#0A66C2] hover:text-white transition-colors"
                >
                  {s.icon}
                  {s.label}
                </a>

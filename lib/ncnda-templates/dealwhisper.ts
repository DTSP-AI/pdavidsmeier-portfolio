...
// DealWhisper Inc. one-way NDA.
// Sourced from NDA OneWay.docx and ported up to DTSP-grade clauses:
// non-compete / non-solicit, reverse-engineering prohibition, DTSA immunity
// notice, jury-trial waiver, 5-year + perpetual trade secret survival,
// Florida governing law and Miami-Dade venue.

export const dealwhisperTemplate: NcndaTemplate = {
  key: "dealwhisper",
  metadata: {
    disclosingPartyName: "DealWhisper Inc.",
    entityDescriptor: "a Florida corporation",
    version: "2026-04-dw-v1",
    summaryParagraphs: [
      "By signing, {{NAME}} on behalf of {{ENTITY}} agrees to hold all Confidential Information of DealWhisper Inc. in strict confidence, use it solely to evaluate a potential engagement, and refrain from disclosing, copying, reverse engineering, or feeding it into any third-party AI, ML, or training system without prior written consent.",
    ...
    footerLine: "DealWhisper Inc. · Confidential",
  },
  body: `# NON-DISCLOSURE AGREEMENT (ONE-WAY / UNILATERAL)
